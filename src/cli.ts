...
program
    ...
    .option('--strategy <type>', 'Extraction strategy: keyframe-only, smart-copy, re-encode', 'smart-copy')
...
program
    ...
    .requiredOption('-i, --input <file>', 'Input video file')
    .requiredOption('-t, --time <time>', 'Timestamp (HH:MM:SS.mmm, seconds, or frames)')
