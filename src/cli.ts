...
program
  ...
  .option(
    ...
    "Extraction strategy: keyframe-only, smart-copy, re-encode\n" +
      "  • keyframe-only: Fastest per-clip, requires keyframe scan\n" +
      "  • smart-copy: Balanced, good for batch (default)\n" +
      "  • re-encode: Frame-perfect, no scan needed (fastest for 1-3 clips)",
    "smart-copy"
  )
